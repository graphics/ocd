...
#define OCDFMTDEF_FILL_EMPTY_1 \
	(1 << 17) /* Empty bits are hard-wired to 1 (default is 0) */
...
enum ocdformat {
 ...
 /* No subsampling */
	...
	OCDFMT_1RGB12 =	OCDFMT_xRGB12 |
			OCDFMTDEF_FILL_EMPTY_1,		/* (15):4:4:4 */

	OCDFMT_BGR12 =	OCDFMT_RGB12 |
			OCDFMTDEF_REVERSED,		/* (0):4:4:4 */
	...
	OCDFMT_1RGB15 =	OCDFMT_xRGB15 |
			OCDFMTDEF_FILL_EMPTY_1,		/* (1):5:5:5 */

	OCDFMT_BGR15 =	OCDFMT_RGB15 |
			OCDFMTDEF_REVERSED,		/* (0):5:5:5 */
	...
	OCDFMT_RGBx15 =	OCDFMT_RGB15 |
			OCDFMTDEF_LEFT_JUSTIFIED,	/* 5:5:5:(0) */
	OCDFMT_RGB015 =	OCDFMT_RGBx15,
	OCDFMT_RGB115 =	OCDFMT_RGBx15 |
			OCDFMTDEF_FILL_EMPTY_1,		/* 5:5:5:(1) */

	OCDFMT_BGRx15 =	OCDFMT_RGB15 |
			OCDFMTDEF_LEFT_JUSTIFIED |
			OCDFMTDEF_REVERSED,		/* 5:5:5:(0) */
